                    ...
                    <div class="col-sm-6 col-sm-offset-3 myform-cont">
                        ...
                        <div class="myform-bottom">
                            ...
                            <div class="form-group">
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="User" type="text" class="form-control" onpaste="return false" minlength="8" MaxLength="20" />
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="TextBox2" runat="server" placeholder="password" type="password" class="form-control" onpaste="return false" minlength="8" MaxLength="20" />
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="confirm password" type="password" class="form-control" onpaste="return false" minlength="8" MaxLength="20" />
                                <br />
                            </div>
