<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carbohidratos.aspx.cs" Inherits="LoginHealthyLife.Carbohidratos" %>
...
<body>
    <form id="form1" runat="server">
        <h1>Carbohidratos</h1>
        <p>
También llamados hidratos de carbono, son los azúcares, fibras y almidones que se encuentran en una gran cantidad de alimentos, tales como frutas, granos, verduras y productos lácteos. Los carbohidratos son uno de los grupos alimenticios básicos y son importantes para llevar una vida saludable.
...
Las fuentes menos saludables incluyen pan blanco, pasteles, refrescos azucarados y otros alimentos altamente procesados o refinados.
        ...
        <p>
<strong>Existen dos tipos de carbohidratos principales:</strong> <br />
<br />
<strong>Azúcar:</strong> Es la forma más simple de los carbohidratos. Se produce de forma natural en algunos alimentos, incluyendo frutas, verduras, leche y productos lácteos. Los azúcares incluyen azúcar de la fruta (fructosa), azúcar de mesa (sacarosa) y azúcar de la leche (lactosa). <br />
<strong>Fibra:</strong> La fibra también es un carbohidrato complejo, se produce de forma natural en frutas, verduras, granos enteros, frijoles cocidos y guisantes. <br />
<br />
<strong>Función de los Carbohidratos:</strong> <br /> 
<br />
Los carbohidratos proporcionan el combustible para el sistema nervioso central y la energía para los músculos. También impiden que la proteína sea utilizada como fuente de energía y permiten el metabolismo de las grasas. <br />
        </p>

        <p> 
<strong>Beneficios de los Carbohidratos:</strong> <br />
<br />
<strong>Protección contra enfermedad:</strong> <br />
...
La fibra también puede proteger contra la obesidad y la diabetes tipo 2, esta es esencial para la salud digestiva óptima. <br />
<br />
...
La fibra dietética ayuda a sentirse lleno, y por lo general viene en los alimentos relativamente bajos en calorías. <br />
<br />
<strong>Deficiencia de carbohidratos:</strong> <br />
...
El uso de proteínas para el combustible en lugar de carbohidratos pone tensión en los riñones, debido a que los subproductos del metabolismo de las proteínas se deben eliminar por la orina. Las personas que no consumen suficientes carbohidratos también pueden sufrir de insuficiencia de fibra, lo que puede causar problemas digestivos y estreñimiento.
        ...
        <p> 
            &nbsp;</p>
        <asp:Button ID="Button1" runat="server" BackColor="#993333" Height="41px" OnClick="Button1_Click" Text="Volver a la Página Anterior" Width="201px" />
    </form>
</body>
</html>
